...
struct CodexPillSealRunAdapterScriptTests {
    ...
    func adapterAcceptsSealRunnerContractAndInvokesCodexPillProofEmitter() throws {
        ...
        #expect(script.contains("remove-active-account-signs-out-before-deletion"))
        ...
        #expect(script.contains("CODEXPILL_ENTRYPOINT=\"make emit-remove-active-account-proof\""))
